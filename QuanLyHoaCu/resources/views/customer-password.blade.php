    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3 sidebar">
                ...
                <a href="{{ route('customer.profile') }}">Hồ Sơ</a>
                <a href="{{ route('customer.password') }}" class="active">Đổi Mật Khẩu</a>
            </div>
                        ...
                        <form action="{{ route('customer.updatePassword') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control input-pass" style="border-top-right-radius: 8px; border-bottom-right-radius: 8px;" id="current-password"
                                        name="current_password" placeholder="Nhập mật khẩu hiện tại">
                                    <span class="toggle-password position-absolute end-0 top-50 translate-middle-y pe-3"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control input-pass" id="new-password" name="password"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control input-pass" id="confirm-password"
                            ...
                            <div>
                                <p class="text-danger" style="font-size: 14px;">**Mật khẩu phải dài 8-16 ký tự, chứa ít nhất:
                                    <br> - 1 Chữ cái viết hoa: K, L
                                    <br> - 1 Chữ cái viết thường: x, s
                                    <br> - 1 Số: 0,1
                                    <br> - 1 Ký tự đặc biệt: ! @ # $ % ^ & *
                                </p>
                            </div>
