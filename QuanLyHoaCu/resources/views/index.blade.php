...
<body>
        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-md-12 col-lg-7">
                    <h4 class="mb-3 text-secondary">Họa cụ chất lượng 100%</h4>
                    <h1 class="mb-5 display-3 text-primary">Chuyên dụng cụ vẽ tranh phổ biến</h1>
                </div>
                <div class="col-md-12 col-lg-5">
                    <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active rounded">
                                <img src="{{ asset('img/but-co.jpg') }}" class="img-fluid w-100 h-product bg-secondary rounded" alt="First slide">
                                <a href="#" class="btn px-4 py-2 text-white rounded">Bút & Cọ</a>
                            </div>
                            <div class="carousel-item rounded">
                                <img src="{{ asset('img/giay-ve.jpg') }}" class="img-fluid w-100 h-product rounded" alt="Second slide">
                                <a href="#" class="btn px-4 py-2 text-white rounded">Giấy vẽ</a>
                            </div>
                        </div>
    ...
    <div class="container-fluid featurs py-5">
        <div class="container py-5">
            <div class="row g-4">
                <div class="col-md-6 col-lg-3 custom-height">
                    <div class="featurs-item text-center rounded bg-light p-4">
                        ...
                        <div class="featurs-content text-center">
                            ...
                            <p class="mb-0">Miễn phí vận chuyển cho đơn hàng trên 500.000 VND</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 custom-height">
                ...
                <div class="col-md-6 col-lg-3 custom-height">
                    <div class="featurs-item text-center rounded bg-light p-4">
                        ...
                        <div class="featurs-content text-center">
                            <h5>Trả hàng trong vòng 30 ngày</h5>
                ...
                <div class="border border-primary rounded position-relative vesitable-item">
                    <form action="{{ route('cart.add') }}" method="POST">
                        ...
                        <a href="{{ route('product.shopDetail', $product->product_id) }}">
                            ...
                            <div class="p-4 rounded-bottom bottom-height">
    ...
    <div class="container-fluid banner bg-secondary my-5">
        <div class="container py-5">
            <div class="row g-4 align-items-center">
                <div class="col-lg-6">
                    <div class="py-4">
                        <h1 class="display-3 text-white">Sản Phẩm Giảm Giá Sâu</h1>
                        <p class="fw-normal display-3 text-dark mb-4">trong cửa hàng chúng tôi</p>
                        <p class="mb-4 text-dark">Tập sketch vẽ chì truyền thống phù hợp với người mới bắt đầu, giúp bạn làm quen với kỹ thuật vẽ cơ bản,
                            rèn luyện khả năng quan sát và kỹ năng vẽ hình học, phong cảnh.</p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="position-relative">
                        <img src="{{ asset('img/giay2.jpg') }}" class="img-fluid w-100 rounded" alt="">
                        <div class="d-flex align-items-center justify-content-center bg-white rounded-circle position-absolute" style="width: 140px; height: 140px; top: 0; left: 0;">
                            <div class="d-flex flex-column">
                                <span class="h2 mb-0">30,000</span>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="text-center mx-auto mb-5" style="max-width: 700px;">
                ...
                <p>Những sản phẩm nhận được đánh giá cao và phản hồi tích cực của các khách hàng tiềm năng.</p>
            </div>
            <div class="row g-4">
                ...
                <div class="col-lg-6 col-xl-4">
                    <form action="{{ route('cart.add') }}" method="POST">
                        ...
                        <input type="hidden" name="productId" value="{{ $product->product_id }}">
                        <input type="hidden" name="quantity" value="1">
                        <div class="p-4 rounded bg-light custom-height">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    <img src="{{ asset('img/'. $product->image) }}" class="img-fluid rounded-circle w-100" style="width: 150px; height: 150px;" alt="">
                                </div>
                                <div class="col-6">
                                    <a href="{{ route('product.shopDetail', $product->product_id) }}" class="h5">{{ $product->product_name }}</a>
                                    ...
                                    <h4 class="mb-3">{{ number_format($product->price, 0, '', ',') }} VND</h4>
                                    <button type="submit" class="btn border border-secondary rounded-pill px-3 text-primary">
                                        <i class="fa fa-shopping-bag me-2 text-primary"></i>Thêm vào giỏ hàng
                                    </button>
                                </div>
    ...
    <div class="container-fluid testimonial py-5">
        <div class="container py-5">
            <div class="testimonial-header text-center">
                ...
                <h1 class="display-5 mb-5 text-dark">Khách hàng phản hồi!</h1>
            </div>
                ...
                <div class="testimonial-item img-border-radius bg-light rounded p-4">
                    <div class="position-relative">
                        ...
                        <div class="mb-4 pb-4 border-bottom border-secondary">
                            <p class="mb-0">Sản phẩm chất lượng, tốt, giá rẻ.</p>
                        </div>
                ...
                <div class="testimonial-item img-border-radius bg-light rounded p-4">
                    <div class="position-relative">
                        ...
                        <div class="d-flex align-items-center flex-nowrap">
                            ...
                            <div class="ms-4 d-block">
                                <h4 class="text-dark">Nguyễn Thanh B</h4>
                                <div class="d-flex pe-5">
                                    <i class="fas fa-star text-primary"></i>
                                    <i class="fas fa-star text-primary"></i>
                                    <i class="fas fa-star text-primary"></i>
                ...
                <div class="testimonial-item img-border-radius bg-light rounded p-4">
                    <div class="position-relative">
                        ...
                        <div class="d-flex align-items-center flex-nowrap">
                            ...
                            <div class="ms-4 d-block">
                                <h4 class="text-dark">Trần Văn A</h4>
                                <div class="d-flex pe-5">
                                    <i class="fas fa-star text-primary"></i>
                                    <i class="fas fa-star text-primary"></i>
                                    <i class="fas fa-star text-primary"></i>
