                ...
                <div class="row g-5">
                    <div class="col-md-12 col-lg-6 col-xl-7">
                        ...
                        <div class="form-item">
                            ...
                            <input type="text" class="form-control" name="shipping_address" placeholder="Số nhà tên đường, Phường/xã, Tỉnh/thành phố ">
                        </div>
                        <div class="form-item">
                        ...
                        <div class="form-item">
                            <textarea name="note" class="form-control mt-3" spellcheck="false" cols="30" rows="11" placeholder="Ghi chú cho đơn hàng"></textarea>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-6 col-xl-5">
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <div class="d-flex align-items-center mt-2">
                                                <img src="{{ asset('img/'. $cart->product->image) }}" class="img-fluid rounded-circle" style="width: 70px; height: 70px;" alt="">
                                            </div>
                                        </th>
                                        <td class="py-5">{{ $cart->product->product_name }}</td>
                                        <td class="py-5">{{ number_format($cart->product->price, 0, '', ',') }} VND</td>
                                        <td class="py-5">{{ $cart->quantity }}</td>
                                        <td class="py-5">{{ number_format($cart->product->price * $cart->quantity, 0, '', ',') }} VND</td>
                                    </tr>
                                    @endforeach
                                    <tr>
                                        <th scope="row">
                                        ...
                                        <td>
                                            <div class="py-3">
                                                <p class="mb-0 text-dark">{{ number_format($subTotal, 0, '', ',') }} VND</p>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="py-3">
                                                <p class="mb-0 text-dark">30,000 VND</p>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="py-3">
                                                <p class="mb-0 text-dark">{{ number_format($subTotal + 30000, 0, '', ',') }} VND</p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <div class="row g-4 text-center align-items-center justify-content-center pt-4">
                            <button type="submit" formaction="{{route('checkout.offline')}}" value="Thanh toán khi nhận hàng" class="btn border-secondary py-3 px-4 text-uppercase w-100 text-primary">Thanh toán khi nhận hàng</button>
                            <button type="submit" formaction="{{route('checkout.vnpay')}}" name="redirect" value="VnPay" class="btn border-secondary py-3 px-4 text-uppercase w-100 text-primary">Thanh toán VnPay</button>
                        </div>
                    </div>
                </div>
            </form>
