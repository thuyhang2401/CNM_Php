            ...
            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                ...
                <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                    <div class="navbar-nav mx-auto">
                        ...
                        <a href="{{ route('product.shop') }}" class="nav-item nav-link active">Sản phẩm</a>
        ...
        <div class="container py-5">
            <div class="row g-4 mb-5">
                <div class="col-lg-8 col-xl-9">
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="border rounded" style="width: 400px; height: 400px;">
                                <a href="#">
                                    <img src="{{ asset('img/'. $product->image) }}" class="img-fluid rounded" alt="Image" style="width: 400px; height: 400px;">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <form action="{{ route('cart.add') }}" method="POST">
                                ...
                                <p class="mb-4">Phí vận chuyển: 13,000 VND</p>
                        ...
                        <div class="col-lg-12">
                            <nav>
                                <div class="nav nav-tabs mb-3" style="display: flex;">
                            ...
                            <div class="tab-content mb-5">
                                        ...
                                        <div class="row g-4">
                                            <div class="col-6">
                                                ...
                                                <div class="row bg-light text-center align-items-center justify-content-center py-2">
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-0">{{ $product->category->category_name }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane" id="nav-mission" role="tabpanel" aria-labelledby="nav-mission-tab">
                                    <div class="d-flex">
                                        ...
                                        <div class="">
                                            <p class="mb-2" style="font-size: 14px;">12/04/2024</p>
                                            <div class="d-flex justify-content-between">
                                                <h5>Nguyễn Văn A</h5>
                                                <div class="d-flex mb-3" style="padding-left: 50px;">
                                                    <i class="fa fa-star text-secondary"></i>
                                                    <i class="fa fa-star text-secondary"></i>
                                                    <i class="fa fa-star text-secondary"></i>
                                                    <i class="fa fa-star text-secondary"></i>
                                            ...
                                            <p>Sản phẩm chất lượng, tốt, giá rẻ. </p>
                                        </div>
                                    </div>
                                    <div class="d-flex">
                                        <img src="{{ asset('img/avatar.jpg') }}" class="img-fluid rounded-circle p-3" style="width: 100px; height: 100px;" alt="">
                                        <div class="">
                                            <p class="mb-2" style="font-size: 14px;">12/07/2024</p>
                                            <div class="d-flex justify-content-between">
                                                <h5>Nguyễn Thanh B</h5>
                                                <div class="d-flex mb-3" style="padding-left: 50px;">
                                                    <i class="fa fa-star text-secondary"></i>
                                                    <i class="fa fa-star text-secondary"></i>
                                                    <i class="fa fa-star text-secondary"></i>
                        ...
                        <div class="col-lg-12">
                            <form action="{{ route('product.shop') }}" method="GET">
                                <div class="input-group w-100 mx-auto d-flex  mb-4">
                                    <input type="search" id="searchString" name="searchString" class="form-control p-3" placeholder="Nhập từ khóa" aria-describedby="search-icon-1">
                                    <button type="submit" id="search-icon-1" class="input-group-text p-3"><i class="fa fa-search"></i></button>
                                </div>
                            </form>
                            <div class="mb-4">
            ...
            <div class="vesitable">
                @if ($products->isEmpty())
                <p style="margin-top: 40px;">Không có sản phẩm tương tự</p>
                @else
                    ...
                    <form action="{{ route('cart.add') }}" method="POST">
                        ...
                        <div class="border border-primary rounded position-relative vesitable-item">
                            <a href="{{ route('product.shopDetail', $product->product_id) }}">
                                ...
                                <div class="p-4 pb-0 rounded-bottom bottom-height">
