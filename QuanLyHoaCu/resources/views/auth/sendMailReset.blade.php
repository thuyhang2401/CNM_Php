        ...
        <div class="row justify-content-center">
            <div class="col-5">
                <div class="mt-3 d-flex justify-content-start">
                    <a href="{{ route('login') }}">< Trở lại</a>
                </div>
                <form action="{{ route('post_forgetPass') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="mt-3">
                        <label>Email</label>
                    ...
                    <button type="submit" class="btn btn-primary w-100 mt-4 text-white">Gửi email</button>
                </form>
            </div>
        </div>
    </div>
