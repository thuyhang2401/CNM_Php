...
<body>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-5">
                <form action="{{ route('post_reset') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    ...
                    <div class="mt-3">
                        ...
                        <div class="input-group">
                            <input id="passwordConfirm" name="passwordConfirm" type="password" class="form-control" aria-describedby="name" required
                    ...
                    <button type="submit" class="btn btn-primary w-100 mt-4 text-white">Đổi mật khẩu</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        const passwordCInput = document.getElementById('passwordConfirm');
