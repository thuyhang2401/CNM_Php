...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('font_admin/css/main.css')); ?>">

    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo e(asset('font_admin/img/apple-touch-icon.png')); ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('font_admin/img/favicon-32x32.png')); ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('font_admin/img/favicon-16x16.png')); ?>">
    <link rel="mask-icon" href="<?php echo e(asset('font_admin/img/safari-pinned-tab.svg')); ?>" color="#00b4b6">
...
<body>
    ...
    <script type="text/javascript" src="<?php echo e(asset('font_admin/js/main.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('font_admin/js/main.min.js')); ?>"></script>
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js"></script>
    <script type="text/javascript" src="<?php echo e(asset('font_admin/js/chart.sample.min.js')); ?>"></script>
...
</html><?php /**PATH D:\Baitap\DoAn_CongNgheMoi\QuanLyHoaCu\resources\views/admin/admin.blade.php ENDPATH**/ ?>