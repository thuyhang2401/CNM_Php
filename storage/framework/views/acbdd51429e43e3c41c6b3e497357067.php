                    ...
                    <div id="wait-confirm" class="tab-pane fade show active">
                        <div class="card border border-primary">
                            ...
                            <table class="table table-sm table-striped mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $waitConfirm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <th scope="row"><?php echo e($item->order_id); ?></th>
                                            <td><?php echo e($item->created_at); ?></td>
                                            <td>
                                                <p class="m-0 p-0"><?php echo e($item->customer_name); ?></p>
                                                <p class="font-weight-light m-0 p-0"><small><?php echo e($item->phone_number); ?></small>
                                                </p>
                                                <p class="font-weight-light m-0 p-0">
                                                    <small><?php echo e($item->shipping_address); ?></small></p>
                                            </td>
                                            <td><?php echo e($item->status); ?></td>
                                            <td><?php echo e($item->total_price); ?></td>
                                            <td><a href="/staff/orders/<?php echo e($item->order_id); ?>" class="text-primary"><small>Xem
                    ...
                    <div id="delivering" class="tab-pane fade">
                        <div class="card border border-primary">
                            ...
                            <table class="table table-sm table-striped mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $delivering; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <th scope="row"><?php echo e($item->order_id); ?></th>
                                            <td><?php echo e($item->created_at); ?></td>
                                            <td>
                    ...
                    <div id="delivered" class="tab-pane fade">
                        <div class="card border border-primary">
                            ...
                            <table class="table table-sm table-striped mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $delivered; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <th scope="row"><?php echo e($item->order_id); ?></th>
                                            <td><?php echo e($item->created_at); ?></td>
                                            <td>
...
<?php echo $__env->make('layouts.staff_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Baitap\DoAn_CongNgheMoi\QuanLyHoaCu\resources\views\staff\orders.blade.php ENDPATH**/ ?>